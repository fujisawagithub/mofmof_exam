...
class RentalHousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create rental_house' do
    assert_difference('RentalHouse.count') do
      post rental_houses_url,
           params: { rental_house: { address: @rental_house.address, age: @rental_house.age, fee: @rental_house.fee,
                                     name: @rental_house.name, remarks: @rental_house.remarks } }
    end
  ...
  test 'should update rental_house' do
    patch rental_house_url(@rental_house),
          params: { rental_house: { address: @rental_house.address, age: @rental_house.age, fee: @rental_house.fee,
                                    name: @rental_house.name, remarks: @rental_house.remarks } }
